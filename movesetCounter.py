#!/usr/bin/python
# -*- coding: latin-1 -*-
#Loads a moveset file created by LogReader and compiles moveset statistics for the given
#Pokemon. The output is the console. If you're doing this for more than one Pokemon at a time,
#you probably want to use batchMovesetCounter.py, which will save you a lot of file I/O.
#Note that figuring out the "most common" movesets is an O(N^2) problem--meaning it will take a
#LONG time for the most common Pokemon in popular tiers like OU.
...
species = keyLookup[sys.argv[1][string.rfind(sys.argv[1],'/')+1:string.rfind(sys.argv[1],'.')]]
